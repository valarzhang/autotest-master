...
class DepartmentTestCase(unittest.TestCase):
    ...
    def tearDownClass(cls):
        test_dataForDepartment.clear_data()
        print("结束执行部门管理脚本")
    ...
    @BeautifulReport.add_test_img("test_1_init_tree")
    ...
    @BeautifulReport.add_test_img("test_3_adddepartment")
    def test_3_adddepartment(self):
        """添加部门"""
    ...
    @BeautifulReport.add_test_img("test_4_editDp")
    def test_4_editDp(self):
        """编辑部门"""
    ...
    @BeautifulReport.add_test_img("test_5_del")
    ...
    @BeautifulReport.add_test_img("test_6_childadd")
    ...
    @BeautifulReport.add_test_img("test_7_del_batches")
    ...
    @BeautifulReport.add_test_img("test_8_searchDp")
    def test_8_searchDp(self):
        """搜索功能验证"""
        print("--------------------开始执行第八条用例，搜索-----------------------")
        dr =self.dr
        self.dr.switch_to.frame(Department(self.dr).iframe_sw[1])
        ...
        sleep(1)
        print("点击重置按钮")
        self.assertEqual(Department(dr).input_deptname.get_attribute('value'),'')
    ...
    @BeautifulReport.add_test_img("test_9_sortDp")
