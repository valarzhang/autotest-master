...
class MyTestCase(unittest.TestCase):
    ...
    @skip_dependon(depend='test_2_add')
    ...
    @skip_dependon(depend='test_4_reUser')
    def test_5_reMou(self):
        ...
        try:
            elenium = variable.check_modules(dr1, farent="系统管理", child="部门管理")
            self.assertNotEqual(elenium, False)
            print(self.user1+"账号下含有部门管理模块")
            print("admin删除账号" + self.user1 + "下的部门管理")
            ...
            elenium = variable.check_modules(dr1, farent="系统管理")
...
if __name__ == '__main__':
    ...
    testsuite.addTest(MyTestCase("test_1_init"))
    testsuite.addTest(MyTestCase("test_2_add"))
    testsuite.addTest(MyTestCase("test_3_edit"))
    testsuite.addTest(MyTestCase("test_4_reUser"))
    testsuite.addTest(MyTestCase("test_5_reMou"))
    testsuite.addTest(MyTestCase("test_6_del_role"))
    testsuite.addTest(MyTestCase("test_7_batdel"))
